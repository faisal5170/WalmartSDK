...
namespace Walmart.Sdk.Marketplace.V3.Payload.Order
{
    ...
    [XmlTypeAttribute(Namespace="http://walmart.com/mp/v3/orders", TypeName="taxType")]
    [XmlRootAttribute("taxType")]
    public class TaxType : BasePayload
    {
        [XmlElement("taxName")]
