...
namespace Walmart.Sdk.Marketplace.V3.Payload.Order
{
    ...
    [XmlTypeAttribute(Namespace="http://walmart.com/mp/v3/orders", TypeName="refundType")]
    [XmlRootAttribute("refundType")]
    public class RefundType : BasePayload
    {
        [XmlElement("refundId")]
        ...
        public RefundType()
        {
            RefundCharges = new List<RefundChargeType>();
        }
    }
}
