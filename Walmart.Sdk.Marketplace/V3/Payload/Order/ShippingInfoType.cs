...
namespace Walmart.Sdk.Marketplace.V3.Payload.Order
{
    ...
    [XmlTypeAttribute(Namespace="http://walmart.com/mp/v3/orders", TypeName="shippingInfoType")]
    [XmlRootAttribute("shippingInfoType")]
    public class ShippingInfoType : BasePayload
    {
        [XmlElement("phone")]
        public string Phone { get; set; }
        [XmlElement("estimatedDeliveryDate")]
        public System.DateTime EstimatedDeliveryDate { get; set; }
        [XmlElement("estimatedShipDate")]
        ...
        /// <summary>
        /// ShippingInfoType class constructor
        /// </summary>
