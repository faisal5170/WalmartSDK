...
namespace Walmart.Sdk.Marketplace.V3.Payload.Order
{
    ...
    [XmlTypeAttribute(Namespace="http://walmart.com/mp/v3/orders", TypeName="refundChargeType")]
    [XmlRootAttribute("refundChargeType")]
    public class RefundChargeType : BasePayload
    {
