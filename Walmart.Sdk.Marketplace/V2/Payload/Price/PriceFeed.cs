...
namespace Walmart.Sdk.Marketplace.V2.Payload.Price
{
    ...
    public class PriceFeed : BasePayload
    {
            [XmlElement("PriceHeader")]
            public FeedHeaderType PriceHeader { get; set; }
            [XmlElement("Price")]
            public List<ItemPriceType> Price { get; set; }
    
        /// <summary>
        /// PriceFeed class constructor
        /// </summary>
        public PriceFeed()
        {
            Price = new List<ItemPriceType>();
            PriceHeader = new FeedHeaderType();
        }
    }
}
