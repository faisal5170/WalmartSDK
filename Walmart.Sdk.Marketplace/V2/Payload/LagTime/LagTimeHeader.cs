...
namespace Walmart.Sdk.Marketplace.V2.Payload.LagTime
{
    ...
    public class LagTimeHeader : BasePayload
    {
        /// <summary>
        /// This indicates schema version associated with the XML payload
        /// </summary>
        [XmlElement("version")]
        public LagTimeHeaderVersion Version { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// LagTimeHeader class constructor
        /// </summary>
        public LagTimeHeader()
        {
            Version = LagTimeHeaderVersion.Item10;
        }
    }
}
