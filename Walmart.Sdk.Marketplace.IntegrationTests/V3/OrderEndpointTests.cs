...
namespace Walmart.Sdk.Marketplace.IntegrationTests.V3
{
    ...
    {
        private readonly Marketplace.V3.Api.OrderEndpoint orderApi;
        ...
        {
            var result = await orderApi.CancelOrderLines("test", GetRequestStub("V3.requestStub.cancelOrderLines"));
            Assert.IsType<Order>(result);
        }
        ...
        {
            var result = await orderApi.RefundOrderLines("test", GetRequestStub("V3.requestStub.refundOrderLines"));
            Assert.IsType<Order>(result);
        }
        ...
        {
            await Assert.ThrowsAsync<Walmart.Sdk.Marketplace.V3.Api.Exception.ApiException>(
